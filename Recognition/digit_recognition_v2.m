...
for i = 1:20
    for j = 1 : 3
        if j ==1
            a_number = sprintf('Dennis_A%d', i);
            b_number = sprintf('ch_A%d', i);
            c_number = sprintf('bo_A%d', i);
            d_number = sprintf('Fan_A%d', i);
            e_number = sprintf('Neeraj_A%d', i);
            f_number = sprintf('Zhang_A%d', i);
        elseif j==2
            a_number = sprintf('Dennis_B%d', i);
            b_number = sprintf('ch_B%d', i);
            c_number = sprintf('bo_B%d', i);
            d_number = sprintf('Fan_B%d', i);
            e_number = sprintf('Neeraj_B%d', i);
            f_number = sprintf('Zhang_B%d', i);            
        elseif j ==3
            a_number = sprintf('Dennis_C%d', i);
            b_number = sprintf('ch_C%d', i);
            c_number = sprintf('bo_C%d', i);        
